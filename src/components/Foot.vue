...
<style scoped>
  .proportion {
    ...
    width: 1320px;
    height: 410px;
    background: url(../assets/images/fantasy/foot-title-bg.png) no-repeat top left;
  }
  ...
  .proportion .chart-legend li:first-child {
    background: url(../assets/images/fantasy/chart-legend-value.png) no-repeat 46px 14px;
  }

  .proportion .chart-legend li:last-child {
    background: url(../assets/images/fantasy/chart-legend-com2.png) no-repeat 14px 14px;
  }

  .tongbi .chart-legend li:nth-child(1) {
    background: url(../assets/images/fantasy/chart-legend-tb.png) no-repeat 14px 14px;
  }

  .tongbi .chart-legend li:nth-child(2) {
    background: url(../assets/images/fantasy/chart-legend-now.png) no-repeat 14px 14px;
  }

  .tongbi .chart-legend li:nth-child(3) {
    background: url(../assets/images/fantasy/chart-legend-hb.png) no-repeat 14px 14px;
  }
